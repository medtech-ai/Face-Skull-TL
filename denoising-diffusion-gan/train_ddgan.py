...
from datasets_prep.masks import BasicDataset
...
def train(rank, gpu, args):
    ...
    if args.dataset == 'masks':
        dataset = BasicDataset(imgs_dir='../other_data/crop_imgs/', masks_dir='../other_data/crop_masks/', train=True)
    ...
    if args.dataset == 'cifar10' or args.dataset == 'stackmnist' or args.dataset == 'masks':    
